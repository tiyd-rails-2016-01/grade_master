...
class PrincipalsControllerTest < ActionController::TestCase
  ...
  test "should create principal" do
    assert_difference('Principal.count') do
      post :create, principal: { email: @principal.email, first_name: @principal.first_name, last_name: @principal.last_name }
    end
  ...
  test "should update principal" do
    patch :update, id: @principal, principal: { email: @principal.email, first_name: @principal.first_name, last_name: @principal.last_name }
    assert_redirected_to principal_path(assigns(:principal))
  end
